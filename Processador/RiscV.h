...
SC_MODULE(RiscV) {
    ...
    enum REGISTERS {
        ...
        S8=24,	S9=25,	A6=16,	A7=17,
        S2=18,	S3=19,	S4=20,	S5=21,
        S6=22,	S7=23,	S10=26,	S11=27,
    ...
    sc_out<int16_t> P_out_Data; //Saída de endereços para cache de dados
    sc_out<int16_t> P_out_Inst; //Saída de endereços para cache de instruções
